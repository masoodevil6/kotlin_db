package gog.my_project.data_base.query.renderer.nodes.select
...
import gog.my_project.data_base.query.dialect.nodes.select.IQuerySelectCapability
import gog.my_project.data_base.query.renderer.interfaces.IRenderContext

class MySqlQuerySelectCapability : IQuerySelectCapability {
