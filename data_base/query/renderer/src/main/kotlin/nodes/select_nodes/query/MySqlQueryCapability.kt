package gog.my_project.data_base.query.renderer.nodes.select_nodes.query
...
import gog.my_project.data_base.query.dialect.nodes.select_nodes.query.IQueryRenderSelectCapability
import gog.my_project.data_base.query.renderer.interfaces.IRenderContext

class MySqlQueryCapability :
    IQueryRenderSelectCapability {
