...
class QueryToolsSelect(
    ...
    protected var columns: MutableList<QueryToolsColumns> = mutableListOf()
    ...
    override fun selectSetup(blockSelect: (IQueryToolsSelect) -> QueryToolsSelect): QueryToolsSelect {
        return  blockSelect(QueryToolsSelect());
    }

    override fun column(columnsName: String): QueryToolsSelect {
